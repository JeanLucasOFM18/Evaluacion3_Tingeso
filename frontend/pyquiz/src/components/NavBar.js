        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#test" className={activeLink === 'test' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('test')}>Tests</Nav.Link>
            </Nav>
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd"><span>Conectate!</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
